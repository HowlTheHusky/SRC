...
void CDPSrvr::OnTeleportByAPP( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long )
{
    ...
    if( IsValidObj( pUser ) )
    {
        ...
        switch( nCurSel )
        {
            case 0: vPos = D3DXVECTOR3(6973.0F, 100.0F, 3328.0F); dwWorldID = 1; break;						// Flaris
            case 1: vPos = D3DXVECTOR3(8495.584F, 100.000F, 3644.055F); dwWorldID = 1; break;				// Saint Morning
            case 2: vPos = D3DXVECTOR3(3900.250732F, 59.0F, 4377.806641F); dwWorldID = 1; break;			// Darkon
            case 3: vPos = D3DXVECTOR3(5574.530273F, 75.001129F, 3900.282227F); dwWorldID = 1; break;		// Darkon 1
            case 4: vPos = D3DXVECTOR3(3240.482910F, 11.316653F, 3409.634766F); dwWorldID = 1; break;		// Darkon 3
            case 5: vPos = D3DXVECTOR3(881.142883F, 183.273331F, 1008.118652F); dwWorldID = 206; break;		// Vulcano
            case 6: vPos = D3DXVECTOR3(6642.931152F, 58.000000F, 6454.676758F); dwWorldID = 1; break;		// Aminus
            case 7: vPos = D3DXVECTOR3(6785.000000F, 100.699989F, 6062.000000F); dwWorldID = 1; break;		// Cursed Aminus
            case 8: vPos = D3DXVECTOR3(5986.8989f, 100.0f, 5414.0f); dwWorldID = 1; break;					// Shaduwar
            case 9: vPos = D3DXVECTOR3(4908.647F, 100.000F, 3457.677F); dwWorldID = 1; break;				// Malamute Tramnuk
            case 10: vPos = D3DXVECTOR3(5267.235F, 100.000F, 4719.388F); dwWorldID = 1; break;				// Tramnuk
            case 11: vPos = D3DXVECTOR3(7130.632F, 100.000F, 7099.972F); dwWorldID = 1; break;				// Knochenpfad
            case 12: vPos = D3DXVECTOR3(6366.140F, 100.000F, 8050.609F); dwWorldID = 1; break;				// Crystal Dungeon
            case 13: vPos = D3DXVECTOR3(3901.406F, 59.000F, 3911.420F); dwWorldID = 1; break;				// Clockworks Raum
            case 14: vPos = D3DXVECTOR3(256.689F, 100.000F, 229.213F); dwWorldID = 5; break;				// Test Map
			/*
            ...
            case 19: vPos = D3DXVECTOR3(6501.000F, 66.000F, 9095.00F); dwWorldID = 1; break; 
            case 20: vPos = D3DXVECTOR3(6593.000F, 100.000F, 5076.000F); dwWorldID = 1; break;
