...
void CWndTeleporter::OnDraw( C2DRender* p2DRender )
{
	...
	case 13:
		strFile = "darkon3.tga";
		strLandName ="Clockworks Raum";
		strDes= "";
		break;
	case 14:
		strFile = "flaris.tga";
		strLandName ="Test Map";
		strDes = "";
		break;
	/*
    case 6000: 
...
void CWndTeleporter::OnInitialUpdate( void )
{
    ...
    pListBox->AddString("Flaris");			//0
    pListBox->AddString("Saint Morning");	//1
    pListBox->AddString("Darkon");			//2
    pListBox->AddString("Darkon 1");		//3
    pListBox->AddString("Darkon 3");		//4
    pListBox->AddString("Vulcano");			//5
    pListBox->AddString("Aminus");			//6
    pListBox->AddString("Cursed Amnius");	//7
	pListBox->AddString("Shaduwar");		//8
    pListBox->AddString("Malamute Tramnuk");//9
    pListBox->AddString("Tramnuk");			//10
    pListBox->AddString("Knochenpfad");		//11
    pListBox->AddString("Crystal Dungeon");	//12
	pListBox->AddString("Clockworks Raum");	//13
	pListBox->AddString("Test Map");		//14
    //pListBox->AddString("Behemoth D.");	//16
    //pListBox->AddString("Khaldera");		//16
    //pListBox->AddString("Bahara Desert");	//17
    //pListBox->AddString("Sanpres 1");		//18
    //pListBox->AddString("Sanpres 2");		//19
    //pListBox->AddString("Upresia 1");		//20
    //pListBox->AddString("Upresia 2");		//21
    //pListBox->AddString("Herneos 1");		//22
    //pListBox->AddString("Herneos 2");		//23
    //pListBox->AddString("Kalgas Cave");	//24
    //pListBox->AddString("Eillun");		//25
}
