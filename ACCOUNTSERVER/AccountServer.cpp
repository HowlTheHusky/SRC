...
//   InitEH();
	...
	CheckMenuItem( hMenu, IDM_OPT_EXTERNAL, MF_CHECKED ); //cuvvvie
	EnableMenuItem( hMenu, IDM_OPT_EXTERNAL, MF_DISABLED | MF_GRAYED ); //cuvvvie
	g_dpSrvr.m_bCheckAddr	= false;	//cuvvvie
